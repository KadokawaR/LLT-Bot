...
public class Speech {
    ...
    public static final String help = "输入下方带有斜杠的关键词可以获得相关信息。\n\n" +
                                ...
                                "/funct 功能列表\n"+
                                "/conta 联系开发者";
    public static final String intro = "七筒是一个用于服务简体中文 Furry 社群的 QQ 机器人项目，皆在试图为群聊增加一些乐趣。请发送/funct 来了解如何使用七筒。注意，不要和我，也不要和生活太较真。";
    public static final String usage ="点击头像添加七筒为好友（或者添加号码 340865180），并将其邀请到QQ群聊中，即可在该群聊中使用七筒的服务。\n\n" +
                                "如果需要查看七筒的功能列表，请输入/funct。";
    public static final String funct = "输入下方的关键词即可使用对应功能。\n\n" +
                                "兽设 -> 获取你的今日兽设。\n"+
    ...
    public static final String conta ="如果需要联系七筒的开发者，请直接添加七筒好友，并在发送消息的开头注明”意见反馈“。只有含有“意见反馈”字样的单条消息才会被接收。如有其他问题，请添加开发者好友，号码：2955808839。";
}
